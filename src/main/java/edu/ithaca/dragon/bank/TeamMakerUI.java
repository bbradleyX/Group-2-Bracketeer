...
public class TeamMakerUI {
    ...
    public static Team runTeamMakerUI(){
        ...
        while((Team.isValidName(name) == false)){//calls the method isValidName so that the user enters a valid name for the team
        ...
        System.out.println("You have now created a new Team: " + newTeam.getTeamName());
        scanner.close();
